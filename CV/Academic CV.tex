...
\moveleft.5\hoffset\centerline{2/6 Brunton Place} % Your address
\moveleft.5\hoffset\centerline{EH75EG, Edinburgh, United Kingdom}
\moveleft.5\hoffset\centerline{(+34) 622925412}
\moveleft.5\hoffset\centerline{\href{mailto:frarodri@eco.uc3m.es}{frodrigu@ed.ac.uk}}
...
\section{Education}
{\bf Universidad Carlos III de Madrid} \hfill March 2021 (expected)  \\
...
{\bf The Sex Ratio, Marriage, and Bargaining: a Chinese Story} \\
...
{\bf Childcare subsidies and pensions} (joint with Lidia Cruces) \\
...
{\bf 2020:} Virtual Macro-Development-Trade-Environment Reading Group Workshop at Iowa State University (upcoming).
